...
\label{eq:localsr}
\end{equation}
at the tangent-space level. Relative velocities obey \eqref{eq:gammafactor}. A local inertial frame does not remove curvature. Reducing laboratory size reduces finite-region corrections, not curvature itself. Nothing here selects a physical \Aether{} rest frame.
